// CONFIGURACIÓN DE LAS PÁGINAS DEL CUENTO (16 Páginas)
const paginasCuento = [
  {
    imagen: "imagenes/pagina-01.webp",
    audio: "audios/no-pag1.mp3",
    calzonSrc: "imagenes/calzon-normal.webp",
    postura: "postura-flotar",
    coordenadas: { top: "25%", left: "65%" }
  },
  {
    imagen: "imagenes/pagina-02.webp",
    audio: "audios/no-pag2.mp3",
  ...
  },
  {
    ...
    audio: "audios/no-pag3.mp3",
    calzonSrc: "imagenes/calzon-normal.webp",
    postura: "postura-asustado",
    coordenadas: { top: "80%", left: "45%" }
  },
  {
    imagen: "imagenes/pagina-04.webp",
    audio: "audios/no-pag4.mp3",
    calzonSrc: "imagenes/calzon-mareado.webp",
    postura: "postura-mareado",
  ...
  },
  {
    ...
    audio: "audios/no-pag7.mp3",
    calzonSrc: "imagenes/calzon-normal.webp",
    postura: "postura-flotar",
    coordenadas: { top: "70%", left: "65%" }
  },
  {
    imagen: "imagenes/pagina-08.webp",
    audio: "audios/no-pag8.mp3",
    calzonSrc: "imagenes/calzon-mareado.webp",
    postura: "postura-mareado",
    coordenadas: { top: "60%", left: "45%" }
  },
  {
    imagen: "imagenes/pagina-09.webp",
    audio: "audios/no-pag9.mp3",
    calzonSrc: "imagenes/calzon-normal.webp",
    postura: "postura-asustado",
    coordenadas: { top: "60%", left: "55%" }
  },
  {
    imagen: "imagenes/pagina-10.webp",
    audio: "audios/no-pag10.mp3",
    calzonSrc: "imagenes/calzon-mareado.webp",
    postura: "postura-mareado",
    coordenadas: { top: "30%", left: "65%" }
  },
  {
    imagen: "imagenes/pagina-11.webp",
    audio: "audios/no-pag11.mp3",
    calzonSrc: "imagenes/calzon-normal.webp",
    postura: "postura-flotar",
    coordenadas: { top: "70%", left: "45%" }
  },
  {
    imagen: "imagenes/pagina-12.webp",
    audio: "audios/no-pag12.mp3",
    calzonSrc: "imagenes/calzon-mareado.webp",
    postura: "postura-mareado",
    coordenadas: { top: "75%", left: "35%" }
  },
  {
    imagen: "imagenes/pagina-13.webp",
    audio: "audios/no-pag13.mp3",
    calzonSrc: "imagenes/calzon-normal.webp",
    postura: "postura-flotar",
    coordenadas: { top: "75%", left: "55%" }
  },
  {
    imagen: "imagenes/pagina-14.webp",
    audio: "audios/no-pag14.mp3",
    calzonSrc: "imagenes/calzon-mareado.webp",
    postura: "postura-mareado",
    coordenadas: { top: "60%", left: "25%" }
  },
  {
    imagen: "imagenes/pagina-15.webp",
    audio: "audios/no-pag15.mp3",
    calzonSrc: "imagenes/calzon-normal.webp",
    postura: "postura-flotar",
    coordenadas: { top: "50%", left: "55%" }
  },
  {
    imagen: "imagenes/pagina-16.webp",
    audio: "audios/no-pag16.mp3",
    calzonSrc: "imagenes/calzon-mareado.webp",
    postura: "postura-mareado",
    coordenadas: { top: "10%", left: "65%" }
  }
];
...
// ========================================================
// CONTROL DE ARRANCADO UNIFICADO
// ========================================================
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Si cumple cualquiera de las dos condiciones del encadenador principal
  if (vieneDeEncadenadorURL || vieneDeEncadenadorSesion) {
    document.getElementById('pantalla-inicio').classList.add('oculto');
    document.getElementById('visor').classList.remove('oculto');
    
    // Saltamos directo a la página 2 (índice 1) como requiere el flujo
    paginaActual = 1; 
    cargarPagina();
  } else {
    // Entrada manual e independiente: no reproduce sonido hasta que el usuario interactúe (Modo Seguro PWA)
    console.log("Entrada independiente. Esperando clic en Comenzar.");
  }
});